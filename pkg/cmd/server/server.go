...
import (
	...
	"github.com/qiujian16/fleet-gateway/pkg/cmd/server/options"
	genericapiserver "k8s.io/apiserver/pkg/server"
	utilversion "k8s.io/apiserver/pkg/util/version"
)

func NewServerCommand(ctx context.Context, out, errOut io.Writer) *cobra.Command {
	o := options.NewGatewayServerOptions(out, errOut)
...
func Run(ctx context.Context, o *options.GatewayServerOptions) error {
	config, err := o.Config()
	if err != nil {
		return err
	}
